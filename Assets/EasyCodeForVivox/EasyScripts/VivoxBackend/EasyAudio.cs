...
namespace EasyCodeForVivox
{
    ...
    public class EasyAudio : IAudio
    {
        ...
        {
            var device = EasySessionStatic.Client.AudioInputDevices.AvailableDevices.Where(d => d.Key == keyArgs.Key).FirstOrDefault();
        ...
        {
            var device = EasySessionStatic.Client.AudioOutputDevices.AvailableDevices.Where(d => d.Key == keyArgs.Key).FirstOrDefault();
            if (!_settings.LogAllAudioDevices) { return; }
